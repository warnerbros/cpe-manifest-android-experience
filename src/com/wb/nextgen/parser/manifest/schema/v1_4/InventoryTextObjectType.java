...
public class InventoryTextObjectType {
    ...
    protected List<TextString> textString;
     ...
     *     
     */
    public void setContainerReference(ContainerReference value) {
     ...
     * 
     */
    public List<TextString> getTextString() {
        if (textString == null) {
            textString = new ArrayList<TextString>();
        }
